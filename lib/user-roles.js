...
export const ROLE_DEFAULT_PERMISSIONS = {
  ...
  regio_manager: [
    ...
    'page.retour-redenen','page.retour-cohort','page.shopify-refunds','page.transport-pickups','page.transport-verdeling',
  ...
  office: [
    ...
    'page.customer-segments','page.klantvragen',
    'page.sc-dashboard','page.hq-bot','page.transport-verdeling',
    /* Marketing-suite */
  ...
  finance: [
    ...
    'page.cost-check','page.inkoop-orders','page.shopify-refunds','page.srs-dataexport',
  ...
  readonly: [
    ...
    'page.customer-segments','page.transport-pickups','page.transport-verdeling',
    'data.all-stores'
  ]
};
