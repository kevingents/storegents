...
export const PERMISSIONS = [
  ...
  { category: 'Voorraad & artikelen', key: 'action.merchandiser-verplaats', label: 'Merchandiser: verplaatsing naar SRS boeken' },
  ...
  { category: 'Transport', key: 'page.transport-verdeling',    label: 'Transport-verdeling (consument/winkel/deelzendingen/tarieven)' },
  ...
  { category: 'Rapportages & data', key: 'page.forecast',                      label: 'Budget & forecast (omzet-prognose)' },
  ...
  /* ───────── Studentenverenigingen (= "Students"-menu) ───────── */
  { category: 'Studentenverenigingen', key: 'page.students-overzicht',     label: 'Students — overzicht' },
  ...
  { category: 'Studentenverenigingen', key: 'page.groepen',                label: 'Verenigingen & groepen' },
  { category: 'Studentenverenigingen', key: 'page.gala-kalender',          label: 'Gala-/evenementenkalender' },
  ...
  { category: 'Inkoop', key: 'page.cost-check',      label: 'Kostprijs vs inkoopprijs (verschillen/leeg)' },
  ...
  { category: 'HR', key: 'page.hr-verzuim',          label: 'Verzuim (ziekteverzuim-KPI’s)' },
  ...
  /* ───────── Golf 38-53: nageregistreerde functies (beheerbaar via rechten) ───────── */
  /* Marketing */
  { category: 'Marketing', key: 'page.marketing-campagnes',     label: 'Marketingcampagnes' },
  { category: 'Marketing', key: 'page.marketing-poas',          label: 'Marketing POAS / MER' },
  { category: 'Marketing', key: 'page.marketing-analytics',     label: 'Marketing analytics' },
  { category: 'Marketing', key: 'page.marketing-advisor',       label: 'Marketing advisor' },
  { category: 'Marketing', key: 'page.marketing-search-terms',  label: 'Marketing zoektermen' },
  { category: 'Marketing', key: 'page.marketing-contentbeheer', label: 'Marketing contentbeheer' },
  { category: 'Marketing', key: 'page.marketing-assets',        label: 'Brandbook / assets' },
  { category: 'Marketing', key: 'page.marketing-beeldbank',     label: 'Beeldbank' },
  { category: 'Marketing', key: 'page.marketing-boost',         label: 'Meta-boost (advertenties)' },
  { category: 'Marketing', key: 'page.marketing-vaaksamen',     label: 'Vaak samen gekocht' },
  { category: 'Marketing', key: 'page.marketing-fotograaf',     label: 'Fotograaf-planning' },
  { category: 'Marketing', key: 'page.brand-fit',               label: 'Brand-fit' },
  { category: 'Marketing', key: 'page.content-calendar',        label: 'Contentkalender' },
  { category: 'Marketing', key: 'page.content-checks',          label: 'Content-checks' },
  { category: 'Marketing', key: 'page.newsletters',             label: 'Nieuwsbrieven' },
  { category: 'Marketing', key: 'page.pushowl',                 label: 'PushOwl (web-push)' },
  { category: 'Marketing', key: 'page.spotler',                 label: 'Spotler-statistieken' },
  { category: 'Marketing', key: 'page.social-stats',            label: 'Social-statistieken' },
  { category: 'Marketing', key: 'page.running-ads',             label: 'Lopende advertenties' },
  { category: 'Marketing', key: 'page.seo-ranking',             label: 'SEO-ranking' },
  { category: 'Marketing', key: 'page.ai-visibility',           label: 'AI-zichtbaarheid' },
  { category: 'Marketing', key: 'page.product-audit',           label: 'Product-audit (content)' },
  /* Voorraad & artikelen */
  { category: 'Voorraad & artikelen', key: 'page.voorraad-locaties',           label: 'Voorraad-locaties' },
  { category: 'Voorraad & artikelen', key: 'page.voorraad-locatie-dekking',    label: 'Locatie-dekking' },
  { category: 'Voorraad & artikelen', key: 'page.voorraad-sku-diagnose',       label: 'SKU-diagnose' },
  { category: 'Voorraad & artikelen', key: 'page.voorraad-magazijn-vs-winkel', label: 'Voorraad magazijn vs winkel' },
  { category: 'Voorraad & artikelen', key: 'page.stock-reconcile',             label: 'Stock-reconcile' },
  { category: 'Voorraad & artikelen', key: 'page.dragers-history',             label: 'Dragers-historie' },
  { category: 'Voorraad & artikelen', key: 'page.size-bracketing',             label: 'Maatverdeling' },
  /* Rapportages & data */
  { category: 'Rapportages & data', key: 'page.fast-omnichannel',         label: 'Snelle omnichannel-score' },
  { category: 'Rapportages & data', key: 'page.retail-anomaly',           label: 'Retail-anomalieën' },
  { category: 'Rapportages & data', key: 'page.forecast-voorraad-risico', label: 'Forecast voorraad-risico' },
  { category: 'Rapportages & data', key: 'page.srs-dataexport',           label: 'SRS data-export' },
  { category: 'Rapportages & data', key: 'page.monthly-store-mail-stats', label: 'Winkel-mailstatistieken' },
  /* Orders & verkoop */
  { category: 'Orders & verkoop', key: 'page.retour-redenen',  label: 'Retour-redenen' },
  { category: 'Orders & verkoop', key: 'page.retour-cohort',   label: 'Retour-cohort' },
  { category: 'Orders & verkoop', key: 'page.shopify-refunds', label: 'Shopify refunds' },
  /* Transport */
  { category: 'Transport', key: 'page.transport-pickups', label: 'Transport-pickups' },
  /* Klanten */
  { category: 'Klanten', key: 'page.customer-segments', label: 'Klant-segmenten' },
  { category: 'Klanten', key: 'page.klantvragen',       label: 'Klantvragen' },
  /* Inkoop */
  { category: 'Inkoop', key: 'page.inkoop-orders', label: 'Inkooporders (overzicht)' },
  /* Suitconcer */
  { category: 'Suitconcer', key: 'page.sc-dashboard', label: 'Suitconcer dashboard' },
  /* Systeem */
  { category: 'Systeem', key: 'page.hq-bot', label: 'HQ-bot' },
...
export const ROLE_DEFAULT_PERMISSIONS = {
  ...
  regio_manager: [
    ...
    'page.routeplanning','page.niet-leverbaar','page.retouren',
    'page.klanten','page.klant-zoeken',
    'page.finance','page.declaraties','page.omzet',
    'page.rapportages','page.jaaranalyse','page.forecast','page.rapportbouwer','page.logs','page.exports',
    'action.refund','action.cancel-order','action.create-label',
    'action.edit-customer','action.gdpr-export',
    'action.approve-declaration',
    'page.hr','page.hr-verlof','page.hr-verzuim','page.hr-vacatures','action.manage-vacancies',
    'page.inkoop-open','page.inkoop-nieuw','page.inkoop-orders','page.leveranciers','page.cost-check','action.inkoop-mail','action.inkoop-push',
    'page.voorraad-gezondheid','page.merchandiser','action.merchandiser-verplaats',
    'page.voorraad-locaties','page.voorraad-locatie-dekking','page.voorraad-sku-diagnose','page.voorraad-magazijn-vs-winkel','page.stock-reconcile','page.dragers-history','page.size-bracketing',
    'page.retour-redenen','page.retour-cohort','page.shopify-refunds','page.transport-pickups','page.transport-verdeling','page.transport-facturen',
    'page.fast-omnichannel','page.retail-anomaly','page.forecast-voorraad-risico',
    'page.customer-segments','page.klantvragen',
    'data.own-region'
  ],

  shop_manager: [
    'page.dashboard','page.afhaalorders','page.openstaande-orders','page.te-laat',
    'page.niet-leverbaar','page.retouren',
    'page.klanten','page.klant-zoeken',
    'page.declaraties','page.omzet','page.store-revenue-detail',
    'page.rapportages',
    'action.refund','action.cancel-order','action.create-label',
    'action.edit-customer',
    'page.hr','page.hr-verlof','page.hr-vacatures',
    'page.retour-redenen','page.retour-cohort','page.klantvragen',
    'data.own-store'
  ],
  ...
  office: [
    ...
    'page.klanten','page.klant-zoeken',
    'page.rapportages','page.jaaranalyse','page.forecast','page.logs','page.exports',
    'page.voorraad-gezondheid','page.merchandiser',
    'page.voorraad-locaties','page.voorraad-locatie-dekking','page.voorraad-sku-diagnose','page.voorraad-magazijn-vs-winkel','page.stock-reconcile','page.dragers-history','page.size-bracketing',
    'page.gala-kalender',
    'page.declaraties','page.omzet',
    'page.fast-omnichannel','page.retail-anomaly','page.forecast-voorraad-risico','page.srs-dataexport','page.monthly-store-mail-stats',
    'page.retour-redenen','page.retour-cohort','page.shopify-refunds',
    'page.customer-segments','page.klantvragen',
    'page.sc-dashboard','page.hq-bot','page.transport-verdeling','page.transport-facturen',
    /* Marketing-suite */
    'page.marketing-campagnes','page.marketing-poas','page.marketing-analytics','page.marketing-advisor','page.marketing-search-terms','page.marketing-contentbeheer','page.marketing-assets','page.marketing-beeldbank','page.marketing-boost','page.marketing-vaaksamen','page.marketing-fotograaf','page.brand-fit','page.content-calendar','page.content-checks','page.newsletters','page.pushowl','page.spotler','page.social-stats','page.running-ads','page.seo-ranking','page.ai-visibility','page.product-audit',
    'data.all-stores'
  ],
  ...
  finance: [
    'page.dashboard',
    'page.finance','page.declaraties','page.omzet',
    'page.rapportages','page.jaaranalyse','page.forecast','page.exports',
    'page.cost-check','page.inkoop-orders','page.shopify-refunds','page.srs-dataexport','page.transport-facturen',
  ...
  readonly: [
    ...
    'page.rapportages','page.jaaranalyse','page.forecast','page.logs','page.exports',
    'page.retour-redenen','page.retour-cohort','page.shopify-refunds',
    'page.fast-omnichannel','page.retail-anomaly','page.forecast-voorraad-risico','page.monthly-store-mail-stats','page.srs-dataexport',
    'page.customer-segments','page.transport-pickups','page.transport-verdeling','page.transport-facturen',
    'data.all-stores'
  ]
};
