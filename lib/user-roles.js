...
export const PERMISSIONS = [
  ...
  /* ───────── WK Poule ───────── */
  { category: 'WK Poule', key: 'page.admin-wk-poule-prijzen', label: 'WK Poule prijzen beheren' },
  { category: 'WK Poule', key: 'page.admin-wk-poule-results',  label: 'WK Poule uitslagen invoeren' },
  { category: 'WK Poule', key: 'page.admin-wk-poule-bonus',    label: 'WK Poule bonus-antwoorden invullen' },
  { category: 'WK Poule', key: 'page.trophy-cabinet',         label: 'Trophy cabinet bekijken' },
