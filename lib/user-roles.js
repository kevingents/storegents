...
export const ROLE_DEFAULT_PERMISSIONS = {
  ...
  regio_manager: [
    ...
    'page.retour-redenen','page.retour-cohort','page.shopify-refunds','page.transport-pickups',
  ...
  readonly: [
    ...
    'page.customer-segments','page.transport-pickups',
    'data.all-stores'
  ]
};
