...
/**
 * Returnt de `updatedAt` van de KPI-config blob. Gebruikt door rapport-endpoints
 * als cache-buster: zodra een target wordt opgeslagen verandert deze timestamp,
 * dus de cache-key mist en de gebruiker ziet direct het effect (i.p.v. de
 * 10-min TTL af te wachten).
 */
export async function readTargetsUpdatedAt() {
