...
const EMPTY = { inkoop: {}, hr: {}, notify: {}, merchandiser: {}, forecast: {}, updatedAt: null };
...
export async function savePortalConfig(patch = {}, actor = 'admin') {
  await mutateJsonBlob(PATH, (d0) => {
    ...
    const next = { inkoop: { ...(d.inkoop || {}) }, hr: { ...(d.hr || {}) }, notify: { ...(d.notify || {}) }, merchandiser: { ...(d.merchandiser || {}) }, forecast: { ...(d.forecast || {}) } };
