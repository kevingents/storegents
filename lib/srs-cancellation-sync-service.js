...
const DEFAULT_STATUSES = 'niet leverbaar,geannuleerd,unavailable,cancelled,canceled,annulled,not available';
...
export async function syncSrsCancellationsForBranch({
  ...
  if (!branch?.branchId) {
    throw new Error('Kies een winkel of geef branchId mee. Alle winkels tegelijk synchroniseren is uitgeschakeld.');
  }
