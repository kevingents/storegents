    ...
    html: `
      <div style="font-family: Arial, sans-serif; color: #0a1f33; line-height: 1.5;">
        ...
        <table cellpadding="8" cellspacing="0" style="border-collapse: collapse;">
          <tr>
            <td><strong>Declaratie ID</strong></td>
          ...
          <tr>
            <td><strong>Naam medewerker</strong></td>
            <td>${employeeName}</td>
          </tr>
          <tr>
            <td><strong>Naam verantwoordelijke</strong></td>
            <td>${responsible}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><strong>Document ondertekend</strong></td>
            <td>${signed}</td>
          </tr>
          <tr>
