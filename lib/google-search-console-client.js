...
export function getGscConfig() {
  /* Het gedeelde Google-OAuth-token (zelfde als Ads/Analytics/Business) is de
     bron van waarheid zodra de scope webmasters.readonly eraan hangt. De aparte
     GSC-env-vars blijven werken als override. */
  ...
  const refreshToken = clean(process.env.GOOGLE_SEARCH_CONSOLE_REFRESH_TOKEN || process.env.GSC_REFRESH_TOKEN) || googleRefreshToken();
