...
export function buildOverviewEmailHtml({ mode, label, range, rows, asOfDay, isFinal, nextTargets, includePodium = true }) {
  ...
  const table = `<h3 style="margin:20px 0 8px;font-size:15px;color:#0a1f33">Per winkel — gesorteerd op % t.o.v. target</h3>
  ...
  const targetBandText = isFinal
    ...
    : `na 7 dagen ≥25%, na 14 dagen ≥50%, na 21 dagen ≥75% = groen, daaronder rood`;
