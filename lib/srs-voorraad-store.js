...
function computeSummary(rows) {
  ...
  const filialen = Array.from(byFiliaal.values()).sort((a, b) => b.shortageUnits - a.shortageUnits);
  ...
  }), { totalSkus: 0, totalStock: 0, skusUnderIdeal: 0, skusOverIdeal: 0, skusOutOfStock: 0, shortageUnits: 0, overstockUnits: 0 });
