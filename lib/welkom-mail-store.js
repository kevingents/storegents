...
const DEFAULT_CONFIG = {
  stores: {
    'GENTS Amsterdam': {
      enabled: true,
      branchId: '15',
      /* Afzender per winkel: GENTS <Winkel> <{winkel}@mail.gents.nl>
         Bv. "GENTS Amsterdam <amsterdam@mail.gents.nl>". Werkt via het
         mail.gents.nl subdomein dat in Resend geverifieerd staat (SPF/DKIM
         op gents.nl DNS zone). */
