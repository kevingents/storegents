...
/* Officieel gedocumenteerd op:
   https://srs.zendesk.com/hc/nl/articles/4403966457489-Webservice-Uitwisseling
   → URL: https://ws.storeinfo.nl/messages/v1/soap/Uitwisseling.php?wsdl=1
   → Message user webservice (SRS_MESSAGE_USER / SRS_MESSAGE_PASSWORD)
   → Methodes: GetAllOpenstaandeUitwisselingen + ProcessOpenstaandeUitwisselingen */
...
/**
 * Leaf-variant: alleen tekst zónder kind-tags ([^<>]). De SRS-response heeft een
 * BUITENSTE <…:Status> om de Header met dáárin de echte <com:Status>completed</…>;
 * de gewone getNodeText pakt dan de hele XML-blob i.p.v. "completed" → ruil werd
 * onterecht als mislukt gezien (zelfde bug als bij retouren).
 */
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tran="https://messages.storeinfo.nl/v1/Uitwisseling/Transactions" xmlns:com="https://messages.storeinfo.nl/v1/Common" xmlns:uit="https://messages.storeinfo.nl/v1/Uitwisseling">
  ...
  /* Leaf-extractie eerst (de echte <com:Status>completed</com:Status>); val terug
