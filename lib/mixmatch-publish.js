...
/* Default template-suffix → template product.<suffix>.json (hier: mix-and-match
   = product.mix-and-match.json). Override via env MIXMATCH_TEMPLATE_SUFFIX. */
export const DEFAULT_TEMPLATE_SUFFIX = clean(process.env.MIXMATCH_TEMPLATE_SUFFIX) || 'mix-and-match';
