...
export const KNOWN_CRONS = [
  ...
  },
  {
    ...
    description: 'Vergelijkt SRS-magazijn met Shopify voorraad en signaleert verschillen (per SKU).',
    defaultSchedule: '50 3 * * *',
    defaultLabel: 'Dagelijks om 03:50 UTC',
    defaultMinIntervalMin: 1440,
    impact: 'medium'
  },
  {
  ...
  },
  {
    ...
    description: '4x per dag: importeert nieuwe Bol-orders en routeert ze naar magazijn/winkel.',
