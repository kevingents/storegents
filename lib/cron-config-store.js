...
export const KNOWN_CRONS = [
  ...
  {
    key: 'shopify-stock-snapshot',
    label: 'Shopify voorraad-snapshot',
    description: 'Bouwt de voorraad-snapshots vanuit Shopify (single source of truth). Vult branch-snapshots + voorraad-rows die alle voorraad-tools lezen. Voorraad = Shopify live, ideaal = SRS-target.',
    defaultSchedule: '*/20 6-22 * * *',
    defaultLabel: 'Elke 20 min 06-22 UTC',
    defaultMinIntervalMin: 20,
    impact: 'high'
  },
  {
    key: 'srs-stock-delta-import',
    label: 'SRS voorraad delta-import (deprecated)',
    description: 'VERVANGEN door shopify-stock-snapshot. Niet meer in vercel.json — alleen handmatig triggerbaar voor SRS-fallback.',
    defaultSchedule: '(handmatig)',
    defaultLabel: 'Deprecated — Shopify is nu de voorraad-bron',
    defaultMinIntervalMin: 5,
    impact: 'low'
  },
  {
    key: 'srs-voorraad-import',
    label: 'SRS voorraad SFTP-import (locaties + ideaal)',
    description: '3x per dag: leest het laatste voorraad-CSV via SFTP. Levert nog bin-locaties + ideaal-targets (die Shopify niet kent); voorraad zelf komt nu uit shopify-stock-snapshot.',
