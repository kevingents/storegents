...
async function readBlobText(url) {
  /* Cache-buster + no-store: anders serveert de CDN tot `cacheControlMaxAge`
     seconden de oude versie ná een schrijf → je ziet een wijziging
     (toevoegen/verwijderen) pas na een handmatige refresh. Met de buster leest
     élk GET-endpoint dat readJsonBlob gebruikt direct de verse waarde. */
