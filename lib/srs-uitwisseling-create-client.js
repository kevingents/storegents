...
function getConfig(vanFiliaal) {
  ...
  /* 4. Fallback op SRS_API_USER/PASSWORD — zelfde credentials als weborders
     en andere SRS-write endpoints. Werkt voor uitwisselingen mits het account
     write-rechten heeft op si_uitwisselingen.php. */
  ...
  throw new Error(
    ...
    'óf zorg dat SRS_API_USER/PASSWORD óf SRS_MESSAGE_USER/PASSWORD ook boek-uitwisseling rechten heeft.'
  );
}
