...
import { bolPost, bolOrdersVersion } from './bol-client.js';
import { readBolCancellationsState } from './bol-cancellations-store.js';
import { fetchBolOrderDetail } from './bol-srs-push.js';
...
async function bolMarkShipped(bolOrderId, { transporterCode, trackAndTrace, shipmentReference }) {
  ...
  return await bolPost(`/orders/${encodeURIComponent(bolOrderId)}/shipment`, body, { method: 'PUT', version: bolOrdersVersion() });
}
