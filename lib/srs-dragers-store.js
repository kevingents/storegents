...
/* Default-deadline stond vroeger op 11+ plekken hardcoded als `48`.
   Nu single source vanuit business-config — wijziging propagateert
   automatisch naar alle drager-flows. Zie docs/CONFIGURATION.md. */
const DEFAULT_DEADLINE_HOURS = BUSINESS_CONFIG.deadlines.dragerHours;
