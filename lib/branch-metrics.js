...
const STORE_ALIASES = new Map([
  ...
  ['uitlevertafel', 'Uitlevertafel'],
  ['uitlever tafel', 'Uitlevertafel'],
  ['filiaal 97', 'Uitlevertafel'],
  ['97', 'Uitlevertafel'],
  ['99', 'GENTS Magazijn'],
  ['700', 'GENTS Showroom'],
...
export function getStoreNameByBranchId(branchId) {
  ...
  if (id === '97') return 'Uitlevertafel';   /* eigen naam zodat het niet als "GENTS Magazijn" (99) dubbel toont */
