...
import { readVoorraadRows, readLocatiesRows, computeMagazijnNietWinkel } from './srs-voorraad-store.js';
...
export const REPORT_BUILDER_SOURCES = {
  ...
  'magazijn-niet-winkel': {
    ...
    defaultColumns: ['sku', 'magazijn', 'magazijnVoorraad', 'winkelsMetTarget'],
    availableFilters: [
      { key: 'sku',           label: 'SKU bevat',        type: 'text',         field: 'sku' },
    ...
    fetcher: async () => computeMagazijnNietWinkel(await readVoorraadRows())
  },
