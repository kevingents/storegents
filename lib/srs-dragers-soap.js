...
function authBlock() {
  return [
    tag('drd:UserName', process.env.SRS_DRAGER_USERNAME || process.env.SRS_USERNAME),
    tag('drd:Password', process.env.SRS_DRAGER_PASSWORD || process.env.SRS_PASSWORD),
    tag('drd:CustomerCode', process.env.SRS_DRAGER_CUSTOMER_CODE || process.env.SRS_CUSTOMER_CODE),
    tag('plt:UserName', process.env.SRS_DRAGER_USERNAME || process.env.SRS_USERNAME),
    tag('plt:Password', process.env.SRS_DRAGER_PASSWORD || process.env.SRS_PASSWORD),
    tag('plt:CustomerCode', process.env.SRS_DRAGER_CUSTOMER_CODE || process.env.SRS_CUSTOMER_CODE)
  ].filter(Boolean).join('');
}
