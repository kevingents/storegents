...
export async function findShopifyCustomerBySrsCustomerId(customerId, namespace = 'gents', key = 'srs_customer_id') {
    ...
    `query FindCustomerByMetafield($query: String!) {
      customers(first: 1, query: $query) {
        nodes {
          ...
          lastName
          displayName
          metafield(namespace: "gents", key: "srs_customer_id") { value }
        }
      }
    }`,
