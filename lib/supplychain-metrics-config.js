...
export const DEFAULT_METRICS = [
  ...
  },
  {
    ...
    category: 'volume',
    icon: 'refresh',
    direction: 'lower-better', /* lager = stabielere voorraad-planning */
    description: 'Stuks heen + retour naar andere filialen — hoog = veel transfer nodig',
    source: 'srs-exchanges',
